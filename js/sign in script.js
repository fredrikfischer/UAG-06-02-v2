...
var checkbox_termsAndConditions = document.getElementById("checkbox_termsAndConditions");
...
function checkSignInInputs() {
	...
	var checkbox_termsAndConditionsSuccessBool = false;
	...
	if(!checkbox_termsAndConditions.checked){
		setErrorFor(checkbox_termsAndConditions, 'Please agree to termes and conditions');
	}else{
		checkbox_termsAndConditionsSuccessBool = true;
		setSuccessFor(checkbox_termsAndConditions);
	}

	if (usernameSuccessBool == true && emailSuccessBool == true && passwordSuccessBool == true && passwordMatchSuccessBool == true && checkbox_termsAndConditionsSuccessBool == true) {
